...
var errorToString = map[int]string{
	...
	ErrSpeaker: "Unknown speaker as local node is a speaker",
	ErrPreResp: "Fail to recognize PrepareResponseMsg",
	ErrChangeV: "Fail to recognize ChangeView",
	// ErrDelegateResult: "Fail to recognize Delegate Result",
	// ErrFinish:         "Fail to recognize Finish Msg",
